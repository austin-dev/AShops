...
public class PlayerBuyOfferItemInput extends PlayerShopInput {
	...
	private PlayerBuyOfferItemInput(PlayerShopSession session) {
		super(session);
	}

	public static PlayerBuyOfferItemInput open(PlayerShopSession session,
			Player player) {
		PlayerBuyOfferItemInput menu = new PlayerBuyOfferItemInput(session);
