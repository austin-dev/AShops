...
public class PlayerSellOfferMenu extends PlayerShopMenu {
	private final PlayerSellOffer offer;
	private final Inventory inventory;
	private final PlayerShopInventoryMenu shopMenu;

	private PlayerSellOfferMenu(PlayerShopInventoryMenu shopMenu,
			PlayerSellOffer offer) {
	...
	public static PlayerSellOfferMenu open(PlayerShopInventoryMenu shopMenu,
		PlayerSellOffer offer, Player player) {
		PlayerSellOfferMenu menu = new PlayerSellOfferMenu(shopMenu, offer);
