...
public class PlayerOfferLoadMenu extends PlayerShopMenu {
	private final PlayerShopOffer offer;
	private final Inventory inventory;
	private final PlayerShopInventoryMenu shopMenu;

	private PlayerOfferLoadMenu(PlayerShopInventoryMenu shopMenu,
	...
	public static PlayerOfferLoadMenu open(PlayerShopInventoryMenu shopMenu,
		PlayerShopOffer offer, Player player) {
		PlayerOfferLoadMenu menu = new PlayerOfferLoadMenu(shopMenu, offer);
	...
	private String getTitle() {
		return getSession().getTranslator().$(ASMessageKey.LOAD_MENU_TITLE);
	}

	private void setupInventory() {
		String clickLine = ChatColor.WHITE
				+ getSession().getTranslator().$(ASMessageKey.LOAD_ICON_CLICK)
				+ ChatColor.WHITE;
		String shiftClickLine = ChatColor.WHITE
				+ getSession().getTranslator().$(ASMessageKey.LOAD_ICON_SHIFT)
				+ ChatColor.WHITE;
