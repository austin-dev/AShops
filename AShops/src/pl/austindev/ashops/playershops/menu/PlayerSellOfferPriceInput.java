...
public class PlayerSellOfferPriceInput extends PlayerShopInput {
	...
	private PlayerSellOfferPriceInput(PlayerShopSession session, ItemStack item) {
		super(session);
		this.item = item;
	}

	public static PlayerSellOfferPriceInput open(PlayerShopSession session,
		Player player, ItemStack item) {
		PlayerSellOfferPriceInput menu = new PlayerSellOfferPriceInput(session,
				item);
