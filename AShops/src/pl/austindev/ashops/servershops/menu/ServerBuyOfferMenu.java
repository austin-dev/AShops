...
public class ServerBuyOfferMenu extends ServerShopMenu {
	private final ServerBuyOffer offer;
	private volatile Inventory inventory;
	private final ServerShopInventoryMenu shopMenu;

	private ServerBuyOfferMenu(ServerShopInventoryMenu shopMenu,
			ServerBuyOffer offer) {
	...
	public static ServerBuyOfferMenu open(ServerShopInventoryMenu shopMenu,
		ServerBuyOffer offer, Player player) {
		ServerBuyOfferMenu menu = new ServerBuyOfferMenu(shopMenu, offer);
	...
	private String getTitle() {
		return new StringBuilder(ChatColor.DARK_GREEN.toString())
				...
				.append(offer.getItem().getItemStack().getType()).toString();
	}
	...
	private String getShiftClickSummaryLine(int i, String price) {
		int maxStackSize = offer.getItem().getItemStack().getMaxStackSize();
		return new StringBuilder(ChatColor.WHITE.toString())
				...
				.append(offer.getPrice().multiply(
						new BigDecimal(maxStackSize * i))).toString();
	}
