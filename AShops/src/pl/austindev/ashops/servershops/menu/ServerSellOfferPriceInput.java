...
public class ServerSellOfferPriceInput extends ServerShopInput {
	private final ItemStack item;

	private ServerSellOfferPriceInput(ServerShopSession session, ItemStack item) {
		super(session);
		this.item = item;
	}

	public static ServerSellOfferPriceInput open(ServerShopSession session,
			Player player, ItemStack item) {
		ServerSellOfferPriceInput menu = new ServerSellOfferPriceInput(session,
				item);
